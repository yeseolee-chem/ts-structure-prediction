...
# ---------------------------------------------------------------------------
# Combo [AE] / [ADE] inference helpers (Idea 2-E ensemble integration)
# ---------------------------------------------------------------------------
...
def predict_ts_AE(
    ...
    """Combo [AE] full inference pipeline (Stages 1-4)."""
...
def predict_ts_ADE(
    ...
    """Combo [ADE] full inference pipeline (IDPP -> xTB -> ensemble -> FM)."""
    from reactot.utils.initial_guess import (
        compute_x0_ADE,
        select_best_from_ensemble,
        ensemble_diversity_stats,
