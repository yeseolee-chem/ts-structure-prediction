...
class ProcessedTS1x(BaseDataset):
    def __init__(
        ...
        **kwargs,
        ...
        # Idea 2-D: optional cache directory for xTB-refined x_0 (npy files
    ...
    def _load_x0(self, idx, pos_R, pos_P, atomic_numbers):
        """
        Load a precomputed x_0 (xTB-refined) from cache, falling back to
        the (R+P)/2 midpoint if no cache entry exists. See
