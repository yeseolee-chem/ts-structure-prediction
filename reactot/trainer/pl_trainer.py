...
class SBModule(LightningModule):
    ...
    def compute_loss(self, batch):
        ...
        # Idea 1-D: pass the graph-distance prior through so en_sb.py can KL-
        # regularize the learned importance against it (or use it directly as
        # fixed weights when learn_importance=False).
