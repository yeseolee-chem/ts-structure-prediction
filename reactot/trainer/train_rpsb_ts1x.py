...
def main(argv=None):
    ...
    # Combo [BE]: chemistry-aware base + stochastic exploration.
    # Training uses K=1, sigma=0 (deterministic IC base); inference callers
    # should use ode_sampling_ensemble with K>=3.
    x0_config = {
        'x0_method': 'b_e',  # "midpoint" | "idpp" | "linear" |
                             # "idpp_clash" | "ic" | "b_e"
        'idpp_max_iter': 200,
        'idpp_tol': 0.01,
        'idpp_lr': 0.01,
