"""
scripts/evaluate_ensemble.py — Combo [AE] K vs sigma ablation.
...
hooks (TODO replace placeholders).
...
def evaluate_one_setting(model, dataset, K, sigma):
    from reactot.run_model import predict_ts_AE
    ...
    for sample in dataset:
        ...
        t0 = time.time()
        result = predict_ts_AE(model, pos_R, pos_P, z,
                                K=K, sigma_base=sigma)
