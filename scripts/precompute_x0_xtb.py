"""
scripts/precompute_x0_xtb.py — Combo [AD]/[ADE] x_0 cache generator.
...
cache directory can then be passed to ProcessedTS1x via ``x0_cache_dir``.
...
사용법:
    python scripts/precompute_x0_xtb.py \\
        ...
        --output_path data/x0_xtb_cache_ADE/ \\
        --n_workers 4 \\
        --interpolate a_d
"""
import argparse
...
def load_task_list(data_path: str, interpolate: str):
    """Project-specific loader. Replace with the dataset's iterator."""
